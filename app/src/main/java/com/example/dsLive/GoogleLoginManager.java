...
public class GoogleLoginManager {
    ...
    public static String name_to_be_enter_GoogleLogin;
    public static String username_to_be_enter_GoogleLoin;
    ...
    public void handleSignInResult(Task<GoogleSignInAccount> completedTask) {
        try {
            ...
            name_to_be_enter_GoogleLogin = Objects.requireNonNull(account.getDisplayName());
            username_to_be_enter_GoogleLoin = Objects.requireNonNull(account.getGivenName());

            try {
                Log.d("loginacttttttttttt", Objects.requireNonNull(account.getDisplayName()));
                Log.d("loginacttttttttttt", Objects.requireNonNull(account.getGivenName()));
                Log.d("loginacttttttttttt", Objects.requireNonNull(account.getEmail()));
                Log.d("loginacttttttttttt", Objects.requireNonNull(account.getPhotoUrl()).toString());
