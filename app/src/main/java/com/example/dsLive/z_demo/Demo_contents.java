   ...
   /* public static List<Post_dummy> getPosts() {
    ...
    public static List<GiftCategory> getGiftCategory() {
        ...
        List<FakeGiftRoot> love = new ArrayList<>(Arrays.asList(
                new FakeGiftRoot(5, R.raw.heart2, 10, FakeGiftRoot.IMAGE),
