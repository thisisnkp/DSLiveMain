...
import com.example.dsLive.databinding.ActivityProfile1Binding;
import com.example.dsLive.modelclass.UserRoot;
import com.example.dsLive.posts.FeedGridActivity;
import com.example.dsLive.reels.VideoListGridActivity;
import com.example.dsLive.retrofit.Const;
import com.example.dsLive.retrofit.UserApiCall;
import com.example.dsLive.user.EditProfileActivity;
import com.example.dsLive.user.FollowersListActivity;
import com.example.dsLive.user.MyLevelListActivity;
import com.example.dsLive.user.complain.ComplainListActivity;
import com.example.dsLive.user.complain.CreateComplainActivity;
import com.example.dsLive.user.freeCoins.FreeDiamondsActivity;
import com.example.dsLive.user.vip.VipPlanActivity;
...
//        binding.btnSetting.setOnClickListener(v ->startActivity(new Intent(ProfileActivity.this, SettingActivity.class)));
        ...
        binding.Blockedidlist.setOnClickListener(v -> startActivity(new Intent(ProfileActivity.this, BlockedUserActivity.class)));
