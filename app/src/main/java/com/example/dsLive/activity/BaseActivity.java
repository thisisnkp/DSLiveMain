...
import com.example.dsLive.socket.CallHandler;
import com.example.dsLive.socket.MySocketManager;
import com.example.dsLive.videocall.CallIncomeActivity;
    ...
    public void getStrickers() {
        ...
        call.enqueue(new Callback<StickerRoot>() {
            ...
            public void onResponse(Call<StickerRoot> call, Response<StickerRoot> response) {
                ...
                Log.w("__BASE_ACTIVITY__", "gifts :" + String.valueOf(response.code()));
                Log.w("__BASE_ACTIVITY__", "gifts :" + String.valueOf(response.body().isStatus()));
                Log.w("__BASE_ACTIVITY__", "gifts :" + String.valueOf(response.body().getSticker()));
            ...
            public void onFailure(Call<StickerRoot> call, Throwable t) {
                Log.d("__BASE_ACTIVITY__", "onFailure: " + t.getMessage());
            }
        });
    }
