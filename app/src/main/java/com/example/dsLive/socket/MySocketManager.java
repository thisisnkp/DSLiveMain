...
public class MySocketManager {
    ...
    private static final String TAG = "SocketManager_1___";
...
//                .setTimeout(3000)
        ...
        socket.once(Socket.EVENT_CONNECT, args -> {
            ...
            socket.on(Const.EVENT_GIFT, args1 -> {
                Log.d("___sticker___", "createGlobal: onnGift " + args1[0].toString());
                for (LiveHandler liveHandler : liveHandlers) {

                    try {
                        Log.d("___sticker___so", "agrs1:  " + args1.toString());
                        Log.d("___sticker___so", "agrs[0]:  " + args1[0].toString());
                        Log.d("___sticker___so", "agrs1[1]:  " + args1[1].toString());
                        Log.d("___sticker___so", "agrs1[2]:  " + args1[2].toString());
                        Log.d("___sticker___so", "agrs1[3]:  " + args1[3].toString());
                        Log.d("___sticker___so", "agrs1[4]:  " + args1[4].toString());
                        Log.d("___sticker___so", "agrs1[5]:  " + args1[5].toString());
                    } catch (Exception e) {
                        Log.e("___sticker___", e.toString());
                    }
