...
import com.example.dsLive.databinding.ItemStickerBinding;
...
public class StickerAdapter extends RecyclerView.Adapter<StickerAdapter.StickerViewHolder> {
    ...
    public void onBindViewHolder(@NonNull StickerViewHolder holder, int position) {
        ...
        Log.i("___stickers___","stickerDummies.get(position) : " + stickerDummyRoot);
        ...
        holder.binding.image.setOnClickListener(v -> {
            ...
            Log.i("___stickers___","holder.binding.image.setOnClickListener : " );
