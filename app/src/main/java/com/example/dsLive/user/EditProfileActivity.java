...
import static com.example.dsLive.GoogleLoginManager.name_to_be_enter_GoogleLogin;
import static com.example.dsLive.GoogleLoginManager.username_to_be_enter_GoogleLoin;
import static com.example.dsLive.Login_Phone_Firebase.login_firebase;
import static com.example.dsLive.Login_Phone_Firebase.phone_number_username;
...
import com.example.dsLive.databinding.ActivityEditProfileBinding;
import com.example.dsLive.modelclass.RestResponse;
...
public class EditProfileActivity extends BaseActivity {
    ...
    private static final String TAG = "Editprofileact________";
    ...
    public static String name_to_be_enter_EditProfile;
    public static String username_to_be_enter_EditProfile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name_to_be_enter_EditProfile = binding.etName.getText().toString();
        username_to_be_enter_EditProfile = binding.etUserName.getText().toString();
...
//        binding.etUserName.setText(userName);
        ...
        if (login_google) {
            Log.d("loginacttttttttttt", "SETTING NAME AND USERNAME DYNAMICALLY FROM GOOGLE SIGNIN");
            if (!Objects.equals(name_to_be_enter_GoogleLogin, "")) {
                binding.etName.setText(name_to_be_enter_GoogleLogin);
            }
            if (!Objects.equals(username_to_be_enter_GoogleLoin, "")) {
                binding.etUserName.setText(username_to_be_enter_GoogleLoin);
            }
        } else if (login_firebase && !Objects.equals(phone_number_username, "")) {
            binding.etName.setText(phone_number_username);
            binding.etUserName.setText(phone_number_username);
        } else {
        ...
        try {
            ...
            if (Objects.requireNonNull(userDummy).getUsername() != null && !userDummy.getUsername().isEmpty()) {
...
//                }
        ...
        binding.tvSubmit.setOnClickListener(v -> {
            Log.i(TAG,"binding.tvSubmit.setOnClickListener(");
            ...
            if(bio.isEmpty())
            {
                Toast.makeText(this, "Enter your bio first", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            if (TextUtils.isEmpty(binding.etAge.getText()))
            {
            ...
            try {
                ...
                if(binding.etAge.getText().toString() != "") {
            ...
            {
                Toast.makeText(this, "Please Try Anonymous Login.", Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
                    ...
                    if (response.code() == 200) {
                        ...
                        if (response.body().isStatus()) {
                            ...
                            try {
                                ...
                                Toast.makeText(EditProfileActivity.this, "Network Error Backend", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(EditProfileActivity.this, "Try Different Signin Some Issue", Toast.LENGTH_SHORT).show();
                        }
                    }
                    else {
                        Toast.makeText(EditProfileActivity.this, "Backend Not Responding", Toast.LENGTH_SHORT).show();
                    }
